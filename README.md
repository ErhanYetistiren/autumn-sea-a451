...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/autumn-sea-a451
```

A live public deployment of this template is available at [https://autumn-sea-a451.templates.workers.dev](https://autumn-sea-a451.templates.workers.dev)
